...
| Risk Assessment / Management | ISO 31000; ISO/IEC 23894; NIST AI RMF; ANSSI, *Développer la confiance dans l'IA à travers une approche par les risques cyber* (v1.0, février 2025, ISBN 978-2-11-167185-0, Licence Ouverte v2.0) | Voluntary; the ANSSI publication is a multi-authority reference document, co-signed by twenty national cybersecurity authorities, and states it is provided *en l'état* with no endorsement implied |
| Admissibility Gate | Decision-gate and change-advisory logic; organisation-defined criteria | Voluntary |
| Controls | ISO/IEC 27002; Essential Eight; NIST SP 800-53; ANSSI, *Recommandations de sécurité pour un système d'IA générative* (v1.0, 29 April 2024, Licence Ouverte v2.0) | Voluntary; Essential Eight mandatory for some Australian Commonwealth entities. The ANSSI recommendations are expressly non-normative save where a regulation provides otherwise, and are calibrated to the threats as at their publication date |
